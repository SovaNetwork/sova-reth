...
/// Sova EVM extends the [`Evm`] type with Optimism and Sova specific types and logic.
#[derive(Debug, Clone)]
pub struct SovaRevmEvm<
    CTX,
    INSP,
...
impl<CTX, INSP, I, P> SovaRevmEvm<CTX, INSP, I, P> {
    /// Consumed self and returns a new Evm type with given Inspector.
    pub fn with_inspector<OINSP>(self, inspector: OINSP) -> SovaRevmEvm<CTX, OINSP, I, P> {
        SovaRevmEvm(self.0.with_inspector(inspector))
    }

    /// Consumes self and returns a new Evm type with given Precompiles.
    pub fn with_precompiles<OP>(self, precompiles: OP) -> SovaRevmEvm<CTX, INSP, I, OP> {
        SovaRevmEvm(self.0.with_precompiles(precompiles))
    }
...
impl<CTX, INSP, I, P> InspectorEvmTr for SovaRevmEvm<CTX, INSP, I, P>
where
...
impl<CTX, INSP, I, P> EvmTr for SovaRevmEvm<CTX, INSP, I, P, EthFrame<EthInterpreter>>
where
    CTX: ContextTr,
    I: InstructionProvider<Context = CTX, InterpreterTypes = EthInterpreter>,
    P: PrecompileProvider<CTX, Output = InterpreterResult>,
